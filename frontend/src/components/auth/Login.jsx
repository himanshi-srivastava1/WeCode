...
const Login = () => {
  ...
  useEffect(() => {
    ...
    if (urlParams.get('registered') === 'true') {
      setSuccess('Account created successfully! Please log in (and check your email for verification).');
    }
  }, []);
          ...
          <form onSubmit={handleEmailLogin} className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                ...
                <a href="/forgot-password" className="text-xs text-purple-600 dark:text-purple-400 hover:text-purple-500 hover:underline transition-colors">
                  Forgot password?
                </a>
              </div>
              <Input
