...
const Signup = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gray-50 dark:bg-[#0f172a] transition-colors duration-300">
      ...
      <div className="absolute top-[-10%] right-[-10%] w-[40%] h-[40%] rounded-full bg-blue-600/30 blur-[120px] pointer-events-none" />
      <div className="absolute bottom-[-10%] left-[-10%] w-[40%] h-[40%] rounded-full bg-purple-600/30 blur-[120px] pointer-events-none" />

      <Card className="w-full max-w-md relative z-10 bg-white/80 dark:bg-white/10 backdrop-blur-xl border-gray-200 dark:border-white/20 shadow-lg dark:shadow-[0_8px_32px_0_rgba(0,0,0,0.36)] text-gray-900 dark:text-white my-8 transition-colors duration-300">
        <CardHeader className="text-center space-y-2">
          <CardTitle className="text-3xl font-bold tracking-tight text-gray-900 dark:text-white">Create an Account</CardTitle>
        ...
        <CardContent className="space-y-6">
          ...
          <form onSubmit={handleEmailSignup} className="space-y-4">
            ...
            <Button
              type="submit"
              className="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 text-white border-0 shadow-lg shadow-blue-500/30 transition-all duration-300 mt-2"
              disabled={isLoading}
            >
          ...
          <div className="text-center text-sm">
            ...
            <a href="/login" className="text-blue-600 dark:text-blue-400 hover:text-blue-500 dark:hover:text-blue-300 font-medium hover:underline transition-colors">
              Log in
            </a>
          </div>
        </CardContent>
